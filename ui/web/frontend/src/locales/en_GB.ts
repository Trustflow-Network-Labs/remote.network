export default {
  message: {
    ...
    workflows: {
      ...
      executionLoadError: 'Failed to load execution details',
      interfaces: 'Interfaces',
      noInterfaces: 'No interfaces found for this execution',
      jobs: 'Jobs',
      jobsCount: 'jobs',
      noJobs: 'No jobs found for this execution',
      nodeId: 'Node ID',
      serviceId: 'Service ID',
      remoteExecutionId: 'Remote Execution ID',
      result: 'Result',
      editor: {
    ...
    services: {
      ...
      entrypointPlaceholder: 'e.g., markitdown python3 node',
      entrypointHelp: 'Space-separated entrypoint command. Overrides the image default.',
      cmd: 'Command',
      cmdPlaceholder: 'e.g., --help input.pdf',
      cmdHelp: 'Space-separated command arguments passed to the entrypoint.',
      interfaces: 'Interfaces',
      ...
      wizard: {
        ...
        fromGit: 'Git Repository',
        fromLocal: 'Local Directory',
        imageName: 'Image Name',
        imageNamePlaceholder: 'e.g., nginx or myregistry.io/myimage',
        imageNameHelp: 'Full image name (with registry if not Docker Hub)',
        imageTag: 'Image Tag',
        imageTagPlaceholder: 'e.g., latest, v1.0.0',
        registryUsername: 'Registry Username',
        registryPassword: 'Registry Password',
        registryAuthHelp: 'Optional credentials for private registries',
        gitRepoUrl: 'Git Repository URL',
        gitRepoPlaceholder: 'e.g., https://github.com/user/repo.git',
        gitBranch: 'Branch',
        gitBranchPlaceholder: 'e.g., main, develop',
        gitUsername: 'Git Username',
        gitPassword: 'Git Password/Token',
        gitAuthHelp: 'Optional credentials for private repositories',
        localPath: 'Local Directory Path',
        localPathPlaceholder: 'e.g., /path/to/dockerfile',
        localPathHelp: 'Path to directory containing Dockerfile or docker-compose.yml',
        usernameOptional: 'Optional',
        passwordOptional: 'Optional',
        passwordTokenOptional: 'Password or access token (optional)',
