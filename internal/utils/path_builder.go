...
type JobPathInfo struct {
	...
	WorkflowJobID      int64  // The workflow_jobs.id from orchestrator (unique identifier for this job)
...
// Pattern: /workflows/<orchestrator_peer>/<workflow_job_id>/jobs/<executor_peer>/<job_exec_id>/<path_type>/
...
// Pattern: /workflows/<orchestrator_peer>/<workflow_job_id>/jobs/<executor_peer>/<job_exec_id>/mounts/<mount_path>/
...
func BuildLocalPeerJobPath(baseDir string, orchestratorPeerID string, workflowJobID int64, pathType PathType) string {
...
// Pattern: /workflows/<orchestrator_peer>/<workflow_job_id>/jobs/<sender_peer>/<sender_job_id>/<receiver_peer>/<receiver_job_id>/<path_type>/
...
func BuildTransferDestinationPath(baseDir string, info JobPathInfo, interfaceType string, interfacePath string) string {
	...
	// Pattern: /workflows/<orchestrator>/<workflow_job_id>/jobs/<sender_peer>/<sender_job>/<receiver_peer>/<receiver_job>/input/
